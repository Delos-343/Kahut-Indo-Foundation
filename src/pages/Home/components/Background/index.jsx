            ...
            <div id="HomeBackgrounds bg-slate-50" style={{ backgroundImage: `url(${Dots})`, backgroundRepeat: 'repeat', backgroundSize: 'contain' }}>
                <div className='max-w-[1440px] mx-auto pt-10 pb-24 px-12 2xl:px-0'>
                    <div className="text-center">
                        <h2 className="drop-shadow-md text-2xl md:text-3xl lg:text-4xl font-semibold text-[#20311d] ">Background</h2>
                    </div>
                    <div className="lg:px-0 pt-16 md:pt-24 lg:flex lg:gap-12 2xl:gap-0">
                        ...
                        <div className='pt-10 lg:pt-0 lg:flex-1'>
                            <div className='bg-[#f2f4ec] px-6 py-10 shadow-lg rounded-lg'>
                                ...
                                <p className='leading-6 text-sm lg:leading-8 lg:text-base text-slate-600 mt-4'>
                            ...
                            <div className='bg-[#f2f4ec] px-6 py-10 shadow-lg rounded-lg my-10'>
                                <div className='flex items-center'>
