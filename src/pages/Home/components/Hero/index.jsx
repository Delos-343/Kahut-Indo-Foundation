            ...
            <div className="mt-10 lg:mt-14">
              <Link to="/contact-us" className="inline-block group">
                <div className="eco-cta-premium relative inline-flex items-center justify-center rounded-full p-[1.5px]">
                  <div className="eco-glow absolute inset-0 rounded-full" />

                  <div className="eco-cta eco-cta-loop relative z-10 inline-flex items-center gap-2 overflow-hidden rounded-full bg-[#41562c] px-6 py-3 transition-all duration-300 ease-out group-hover:-translate-y-1">
                    <p className="relative z-10 text-white/90 text-sm md:text-base font-medium">
                      Hubungi Kami
                    </p>
                  </div>
                </div>
