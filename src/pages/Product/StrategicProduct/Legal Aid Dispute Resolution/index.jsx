...
const legalAidItems = [
  "Establishment & support of Legal Aid (Lembaga Bantuan Hukum / LBH Kahutindo)",
  "Legal consultancy, litigation, paralegal & advocacy services",
  "Conflict & non-Industrial Dispute Mediation & Conciliation",
  "Multi-stakeholders forum facilitation",
  "Legal curator, liquidator",
  "Tenure & civic rights education",
  "Publication & awareness materials",
];

function LegalAidDisputeResolution() {
  return (
...
export default LegalAidDisputeResolution;
